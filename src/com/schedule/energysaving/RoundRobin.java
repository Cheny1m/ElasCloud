    ...
    public void allocate(ArrayList<VirtualMachine> p_vmQueue, ArrayList<DataCenter> p_arr_dc) {
        ...
        while (!vmQueue.isEmpty()) {
            ...
            if(index >= 0 && index < pmQueueOneSize){
                ...
                allocateVm(allocatedDataCenterID,allocatedRackID,vm,arr_dc.get(dataCenterIndex).getArr_lbf().get(rackIndex).getPmQueueThree().get(index-pmQueueOneSize-pmQueueThreeSize));
            }
        }
