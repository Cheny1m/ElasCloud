...
/**
 * The energy saving series algorithm,based on LPT(Long Processing Time First).
 * Requests would be sequenced with decreasing order by processing time and be
 * allocated to PM with lowest utility. Different from the online series
 * algorithm, indices are quite different. Some requests may be rejected int
 * this scheduling process. More methods would be added into class
 * PhysicalMachine.
 *
 * @author Minxian
 *
